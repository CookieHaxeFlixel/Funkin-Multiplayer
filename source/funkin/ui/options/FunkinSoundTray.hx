...
class FunkinSoundTray extends FlxSoundTray
{
  ...
  public function new()
  {
    ...
    for (i in 1...11)
    {
      var bar:Bitmap = new Bitmap(Assets.getBitmapData(Paths.image("ui/soundtray/bars-" + StringTools.lpad(Std.string(i), "0", 2))));
      bar.x = 9;
      bar.y = 5;
    ...
    volumeUpSound = Paths.sound("ui/soundtray/volume-up");
    volumeDownSound = Paths.sound("ui/soundtray/volume-down");
    volumeMaxSound = Paths.sound("ui/soundtray/volume-max");  
  }
